...
use crate::keymaster::permission::{
    ...
    check_manage_users_permission, require_ko_bing_ctx, resolve_caller_info, KeyPerm, KeystorePerm,
};
use crate::keymaster::utils::{AndroidUserId, AppUid, SecureUserId};
use crate::top::kobing::ko_bing::{
    CallerInfo::CallerInfo,
    IKoBingMaintenanceService::{BnKoBingMaintenanceService, IKoBingMaintenanceService},
};
...
impl MaintenanceManager {
    ...
    pub fn new_ko_bing_binder() -> Result<Strong<dyn IKoBingMaintenanceService>> {
        Ok(BnKoBingMaintenanceService::new_binder_with_features(
            Self,
            crate::consts::sid_features(),
        ))
    }
...
#[allow(non_snake_case)]
impl IKoBingMaintenanceService for MaintenanceManager {
    fn onUserAdded(&self, ctx: Option<&CallerInfo>, user_id: i32) -> rsbinder::status::Result<()> {
        let _wp = wd::watch("IKoBingMaintenanceService::onUserAdded");
        let ctx = Some(require_ko_bing_ctx(
            ctx,
            "IKoBingMaintenanceService::onUserAdded",
        )?);
    ...
    fn initUserSuperKeys(
        ...
        let _wp = wd::watch("IKoBingMaintenanceService::initUserSuperKeys");
        let ctx = Some(require_ko_bing_ctx(
            ctx,
            "IKoBingMaintenanceService::initUserSuperKeys",
        )?);
    ...
    fn onUserRemoved(
        ...
        let _wp = wd::watch("IKoBingMaintenanceService::onUserRemoved");
        let ctx = Some(require_ko_bing_ctx(
            ctx,
            "IKoBingMaintenanceService::onUserRemoved",
        )?);
    ...
    fn onUserLskfRemoved(
        ...
        let _wp = wd::watch("IKoBingMaintenanceService::onUserLskfRemoved");
        let ctx = Some(require_ko_bing_ctx(
            ctx,
            "IKoBingMaintenanceService::onUserLskfRemoved",
        )?);
    ...
    fn clearNamespace(
        ...
        let _wp = wd::watch("IKoBingMaintenanceService::clearNamespace");
        let ctx = Some(require_ko_bing_ctx(
            ctx,
            "IKoBingMaintenanceService::clearNamespace",
        )?);
    ...
    fn earlyBootEnded(&self, ctx: Option<&CallerInfo>) -> rsbinder::status::Result<()> {
        let _wp = wd::watch("IKoBingMaintenanceService::earlyBootEnded");
        let ctx = Some(require_ko_bing_ctx(
            ctx,
            "IKoBingMaintenanceService::earlyBootEnded",
        )?);
    ...
    fn migrateKeyNamespace(
        ...
        let _wp = wd::watch("IKoBingMaintenanceService::migrateKeyNamespace");
        let ctx = Some(require_ko_bing_ctx(
            ctx,
            "IKoBingMaintenanceService::migrateKeyNamespace",
        )?);
    ...
    fn deleteAllKeys(&self, ctx: Option<&CallerInfo>) -> rsbinder::status::Result<()> {
        let _wp = wd::watch("IKoBingMaintenanceService::deleteAllKeys");
        let ctx = Some(require_ko_bing_ctx(
            ctx,
            "IKoBingMaintenanceService::deleteAllKeys",
        )?);
    ...
    fn getAppUidsAffectedBySid(
        ...
        let _wp = wd::watch("IKoBingMaintenanceService::getAppUidsAffectedBySid");
        let ctx = Some(require_ko_bing_ctx(
            ctx,
            "IKoBingMaintenanceService::getAppUidsAffectedBySid",
        )?);
    ...
    fn onUserPasswordChanged(
        ...
        let _wp = wd::watch("IKoBingMaintenanceService::onUserPasswordChanged");
        let ctx = Some(require_ko_bing_ctx(
            ctx,
            "IKoBingMaintenanceService::onUserPasswordChanged",
        )?);
